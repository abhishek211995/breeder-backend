...
//   query = `CREATE TABLE IF NOT EXISTS bre_breeder (breeder_id INT NOT NULL AUTO_INCREMENT,farm_id INT NOT NULL,breeder_license VARCHAR(255) NOT NULL,user_id INT NOT NULL,PRIMARY KEY(breeder_id), FOREIGN KEY (user_id) REFERENCES bre_User(id),FOREIGN KEY (farm_id) REFERENCES bre_farm(farm_id))`;
//   connection.query(query, function (err, res) {
//     if (err) throw err;
//     console.log(res);
//   });
